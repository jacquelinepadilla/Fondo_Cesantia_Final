...
public class Guardar_Prestamos extends javax.swing.JFrame {
    ...
    prestamos pres = null;
    Connection cnx = null;
    //prestamos_servicios controlador
    //prestamos modelo
    //Guardar_Prestamos vista
   ...
   public Guardar_Prestamos() {
    ...
    public Guardar_Prestamos(prestamos p_prestamo) {
        ...
        initComponents();
        //int a = Integer.parseInt(txtId_vehiculo.setText(this.vehiculo.getMarca()));
       
//txtId_vehiculo.setText(this.vehiculo.getId_vehiculo());
       jTextField2.setText(this.Prestamos.getFecha());
       jTextField5.setText(this.Prestamos.getUtilidad());
        
        //txtKilometraje.setText(this.vehiculo.getKilometraje());
        //txtPrecio.setText(this.vehiculo.getPrecio())
